...
;
        ...
        Popcorn.plugin( "chapter", { // <---
            ...
            start: function( event, options ){
                ...
                for (var i=0;i<currentChapter;i++) {
                    newLeft -= $("#chapterIndicator li:eq(0)").width();
                    newLeft -= 10;
                }

                console.log("left "+ newLeft);
                $("#chapterIndicator ul").animate({left: newLeft},{duration: 200, queue: false});
    ...
    */
    ...
    $(document).on("tap", "#paused",function(event){
        event.stopPropagation();
        $("#paused").fadeOut(200,function(){
            pop.play();
        });
    ...
    */
    ...
    $(document).on("tap", "video",function(event){
        event.stopPropagation();
        // pause it
            pop.pause();
            $("#paused").fadeIn(100);
