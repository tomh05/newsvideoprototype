...
var overlays = {
        "civil":"<h2>Civil Conflict</h2><p>The crisis in Ukraine began in November last year when pro-Moscow President Viktor Yanukovych abandoned a deal with the EU in favour of stronger ties with Russia.</p><p> Protests erupted in the capital Kiev and quickly escalated as government buildings were seized in cities across the western regions of Ukraine.</p>",
        "region":"<h2>Crash Site Location</h2><img src='../../articles/ukraine-flight/crashsite.gif' width='250' height='180' />",
        "passengers":"<h2>Passengers</h2> <p>At a news conference at Schiphol airport, Malaysia Airlines' European chief Huib Gorter said they were still trying to identify some of the passengers from flight MH17. <p>He said of the passengers that have been identified there were:</p> <ul><li>154 Dutch nationals</li><li>27 Australians</li><li> 23 Malaysians</li><li> 11 Indonesians</li><li> Six Britons</li><li> four Germans</li><li> four Belgians</li><li> three from the Philippines</li><li>one Canadian.</ul><p>All 15 of the crew were Malaysian.</p>",
        "missile":"<h2>Analysis: Jonathan Marcus, BBC News</h2> <p>If it does turn out that the Boeing 777 was shot down by the separatists - with weaponry supplied by Moscow - then it could significantly alter the terms of the whole debate surrounding the Ukraine crisis.</p><p>Over the past few days there has been growing concern among Western governments that Russia was stepping up its military support for the separatists in eastern Ukraine.</p><p>Nato spokesmen insist that more and more heavy military equipment has moved from Russian stockpiles to the separatists across the border.</p>",
    };
